...
impl Input {
    ...
    fn reference<'lowered, S: boltffi_binding::SurfaceLower>(
        &self,
        codec: &CodecNode,
    ...
    fn borrowed_bytes<'lowered, S: boltffi_binding::SurfaceLower>(
        &self,
        codec: &CodecNode,
        borrow: rust_api::DecodeBorrow,
        expansion: &Expansion<'lowered, S>,
    ...
    fn owned<'lowered, S: boltffi_binding::SurfaceLower>(
        &self,
        codec: &CodecNode,
        rust_type: &Type,
        binding: &Ident,
