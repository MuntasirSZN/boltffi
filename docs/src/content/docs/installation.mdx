...
- **For C**: a C11 compiler; CMake 3.20+ to run the repository demo
...
C packaging requires both `staticlib` and `cdylib`. Include `cdylib` for a standalone shared library as well:
