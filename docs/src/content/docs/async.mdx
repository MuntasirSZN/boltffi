...
The C target does not generate async functions, methods, constructors, or async callback traits yet. These examples apply to the other targets. See [C limitations](/docs/c#current-limitations).
