...
double distance = demo_distance(start, end);`}
/>
...
| [C](/docs/c) | Experimental; synchronous APIs |
| Python | Supported |
| C++ | Planned |
| Ruby | Planned |
| Dart | In progress |
...
C currently supports the synchronous APIs described above, with limits on callbacks. Async and stream examples apply to the other targets. See [C limitations](/docs/c#current-limitations).
