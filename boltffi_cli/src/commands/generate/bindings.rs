...
fn generate_header(config: &Config, options: &GenerateOptions) -> Result<()> {
    if !config.is_apple_enabled() && !config.is_android_enabled() {
        return Err(CliError::CommandFailed {
            command: "both targets.apple.enabled and targets.android.enabled are false".to_owned(),
            status: None,
        });
    }
    ...
    let output = expansion
        .generation()
        .render_c_header(format!("{}.h", config.library_name()))
...
pub fn print_coverage(target: &str, output: &GeneratedOutput, deny: bool) -> Result<()> {
...
mod tests {
    ...
    #[test]
    fn kmp_prepare_output_removes_managed_paths_and_preserves_native_outputs() {
    ...
    #[test]
    fn kmp_write_output_cleans_managed_paths_before_writing_files() {
    ...
    #[test]
    fn generation_accepts_kmp_target_before_cargo_probe() {
...
"#,
        ...
        .expect_err("disabled KMP generation should fail before cargo probing");
    ...
    #[test]
    fn generation_accepts_java_target_before_cargo_probe() {
        let config = parse_config(
            r#"
[package]
name = "demo"
...
"#,
        ...
        .expect_err("disabled Java generation should fail before cargo probing");
    ...
    #[test]
    fn generation_accepts_typescript_target_before_cargo_probe() {
        let config = parse_config(
            r#"
[package]
name = "demo"
...
"#,
        ...
        .expect_err("disabled TypeScript generation should fail before cargo probing");
    ...
    #[test]
    fn java_generation_rejects_an_explicit_cargo_target_before_metadata_building() {
        let config = parse_config(
            r#"
[package]
name = "demo"
...
"#,
    ...
    #[test]
    fn java_android_generation_rejects_an_explicit_cargo_target_before_ndk_discovery() {
        let config = parse_config(
            r#"
[package]
name = "demo"
...
"#,
    ...
    #[test]
    fn kmp_generation_requires_experimental_opt_in() {
        let config = parse_config(
            r#"
[package]
name = "demo"
...
"#,
        ...
        .expect_err("KMP generation should require experimental opt-in");
    ...
    #[test]
    fn kmp_strict_generation_still_fails_closed_for_unsupported_surface() {
